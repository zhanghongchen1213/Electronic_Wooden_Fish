 ...
 * @brief    ESPWatch-S3-4G 权威 BSP 资源表
...
/** QMI8658C INT2 中断引脚。 */
#define LEGBOT_BSP_QMI8658C_INT2_GPIO GPIO_NUM_45
...
/** GPS 模块 UART 端口。 */
#define LEGBOT_BSP_GPS_UART_PORT UART_NUM_1
/** GPS 模块 RX 引脚。 */
#define LEGBOT_BSP_GPS_RX_GPIO GPIO_NUM_9
/** GPS 模块 TX 引脚。 */
#define LEGBOT_BSP_GPS_TX_GPIO GPIO_NUM_8
/** GPS 模块唤醒引脚。 */
#define LEGBOT_BSP_GPS_WAKE_GPIO GPIO_NUM_3

/** ML307R 模块 UART 端口。 */
#define LEGBOT_BSP_ML307R_UART_PORT UART_NUM_2
/** ML307R 模块 TX 引脚。 */
#define LEGBOT_BSP_ML307R_TX_GPIO GPIO_NUM_43
/** ML307R 模块 RX 引脚。 */
#define LEGBOT_BSP_ML307R_RX_GPIO GPIO_NUM_44
/** ML307R 模块主动高电平使能引脚。 */
#define LEGBOT_BSP_ML307R_EN_GPIO GPIO_NUM_10
/** ML307R 模块使能有效电平。 */
#define LEGBOT_BSP_ML307R_EN_ACTIVE_LEVEL 1U
/** ML307R 模块关闭电平。 */
#define LEGBOT_BSP_ML307R_EN_INACTIVE_LEVEL 0U
/** ML307R 模块 UART 波特率。 */
#define LEGBOT_BSP_ML307R_UART_BAUD 115200

/** 振动马达控制引脚。 */
#define LEGBOT_BSP_VIBRATION_GPIO GPIO_NUM_11
/** 电源按键引脚。 */
#define LEGBOT_BSP_PWR_KEY_GPIO GPIO_NUM_46
/** BOOT 按键引脚。 */
#define LEGBOT_BSP_BOOT_KEY_GPIO GPIO_NUM_0
/** USB D- 引脚。 */
#define LEGBOT_BSP_USB_D_MINUS_GPIO GPIO_NUM_19
/** USB D+ 引脚。 */
#define LEGBOT_BSP_USB_D_PLUS_GPIO GPIO_NUM_20
...
#define LEGBOT_BSP_SDMMC_ENABLED 0
    ...
    typedef enum
    {
        ...
        LEGBOT_BSP_STAGE_UI_STORAGE,         /**< UI 和存储初始化阶段。 */
    ...
    typedef enum
    {
        ...
        LEGBOT_BSP_RESOURCE_GPS_L76KB_A58,   /**< L76KB_A58 GPS 资源。 */
        LEGBOT_BSP_RESOURCE_ML307R,          /**< ML307R 4G 模块资源。 */
        LEGBOT_BSP_RESOURCE_VIBRATION,       /**< 振动马达资源。 */
        LEGBOT_BSP_RESOURCE_PWR_BOOT_KEYS,   /**< 电源键和 BOOT 键资源。 */
        LEGBOT_BSP_RESOURCE_USB,             /**< USB 下载和调试资源。 */
