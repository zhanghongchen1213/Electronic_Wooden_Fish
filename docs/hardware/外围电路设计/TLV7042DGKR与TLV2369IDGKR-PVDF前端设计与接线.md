...
- `C30926`（100nF/0603）：全板 `C0603/100nF` 共 11 只，各文档口径一致。
- `C45783`（22µF/0805）：本板 `C0805/22uF` 共 3 只且全部落在 `VSYS` 网络，全板需求 3 颗、可用 2 颗、**缺 1 颗**。该料号不属本前端，缺口由电源侧文档（BQ25895、TPS22965）持有，三份文档现已同口径。
