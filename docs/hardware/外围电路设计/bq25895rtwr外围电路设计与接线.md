...
| BQ 输出尚未接入后级 | `VSYS` 仅有 `C17.2 C18.2 U2.15 U2.16 U14.2`；U8、U9 出现在封装列表，但没有任何网络端点 | 后级设计阶段补齐 `VSYS → TPS22965 → VMAIN → TLV62569 → V3V3`，及负载开关控制/偏置。此项属于未完成接口，不是要求把 SYS 直接短接 BAT、V3V3 或 M100。 |
