...
> 文档状态：**设计已收口；ALRT 测试点已由用户确认加入 CW2015CHBD 5 脚**。当前网表仍是修改前版本，ERC、PCB DRC 和样机验证未完成。\
...
|---|---|---|---:|---|---|
| CW2015CHBD 电量计 | CW2015CHBD，TDFN8-EP 2×3 mm | **C881838** | 1 | **嘉立创采购** | 库存表无该型号；下单前核对封装、批次与数据手册 |
...
- 实际原理图位号以网表为准；本次旧网表中该器件为 `CW2015CHBD`。
