...
- **C26413（1µF/0603）**：本对象认领 1 颗。同料号其他认领为 ESP32-S3 文档 1 颗（EN 复位电容）、WS2811 文档 1 颗（VDD 去耦）与 M100EG-C2 文档 1 颗（`VIN` 高频去耦）；最新本板中 0603 1µF 共 5 颗，其余 1 颗落在共享 `V3V3` 网络，无法归属单一器件，不计入任何文档认领。全板合计 4 颗认领 + 1 颗共享，可用 241 颗，**无缺口**。
