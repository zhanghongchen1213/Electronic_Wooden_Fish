...
> 最近核验：通过
> 核验依据网表：`Netlist_Schematic1_2026-09-17 (4).tel` SHA-256 `02f23e1d1c53224937916e599a2861dd7bf7d767c461f91474057e2f3d751cb3`
...
**网表**：`Netlist_Schematic1_2026-09-17 (4).tel`，导出 2026-09-17 23:43，SHA-256 `02f23e1d1c53224937916e599a2861dd7bf7d767c461f91474057e2f3d751cb3`。
...
| 事项 | 类型 | 影响或阻塞 | 依据 / 方法 |
|---|---|---|---|
| 电源端就近去耦归属 | 跨文档修改 | `V3V3` 为全板共享网络，网表无法区分每颗去耦电容的服务对象 | 布局阶段确认本器件电源脚旁有 1µF 量级去耦；手册 p.2 Figure 1 标 1.0µF |
...
- **C26413（1µF/0603）**：本对象认领 1 颗。同料号其他认领为 ESP32-S3 文档 1 颗（EN 复位电容）与 WS2811 文档 1 颗（VDD 去耦）；最新网表中 0603 1µF 共 4 颗，第 4 颗落在共享 `V3V3` 网络，无法归属单一器件，不计入任何文档认领。全板合计 3 颗认领 + 1 颗共享，可用 241 颗，**无缺口**。
