...
| --- | --- | --- | --- |
| USB-C 受电与数据 | 单 USB-C 16P、USB2.0、SMT | `TYPEC-304-ACP16` / LCSC `C165948`（候选） | 机械沉板高度、外壳开孔和屏蔽脚布局[必须样机验证]；不再使用双 Type-C。 |
...
| USB-C 连接器 | TYPEC-304-ACP16 | C165948 | 1 | 推荐初值 | 单 USB-C 16P |
