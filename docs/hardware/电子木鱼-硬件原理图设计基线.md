...
| QMI8658A | I²C IO1/2，INT1 IO41 | `V3V3` | 上板但 MVP 默认不启用 | 不得接 IO45；SA0 地址需扫 |
...
| PVDF 缓冲运放 | TLV2369IDGKR | C2057867 | 1 | 推荐型号 | PVDF 双路 RRIO 缓冲；B 通道按手册固定 |
| PVDF 开漏比较器 | TLV7042DGKR | C2760466 | 1 | 推荐型号 | PVDF 双路开漏比较器；输出极性待测 |
| 电量计 | CW2015CHBD | C881838 | 1 | 网表已核验 | TDFN8-EP 2×3 mm；地址 0x62（Cellwise 手册固定，仍需上电扫描确认无冲突）；见 [CW2015CHBD 设计文档](外围电路设计/CW2015CHBD外围电路设计与接线.md) |
| IMU | QMI8658A | 待核 | 1 | 推荐初值 | SA0=高，0x6B；MVP 默认不启用 |
