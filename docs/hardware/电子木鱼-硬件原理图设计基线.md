...
| V3V3_A 滤波 | 功放低噪声供电 | `V3V3 → 磁珠/负载开关 → V3V3_A` | 只供 NS4150B；功放入口 10 µF+100 nF；ES8311 不得挂此网；不使用 BQ PMID 或 `VMAIN` 直供音频 |
...
| --- | --- | --- | --- | --- |
| CW2015 | I²C IO1/2，参考地址 0x62 | `V3V3` | 电量和低电状态 | 地址、电芯曲线、轮询阻塞 |
